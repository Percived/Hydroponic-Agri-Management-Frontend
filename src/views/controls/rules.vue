      ...
      <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑规则' : '新增规则'" width="600px">
        <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px">
          ...
          <el-form-item label="监控指标" prop="metric">
            <el-select v-model="formData.metric" placeholder="请选择监控指标" style="width: 100%">
          ...
          <el-form-item label="目标设备" prop="target_device_id">
            <el-select v-model="formData.target_device_id" placeholder="请选择执行器" filterable style="width: 100%">
              <el-option
...
// 打开编辑弹窗
function openEditDialog(rule: ControlRule) {
  isEdit.value = true
